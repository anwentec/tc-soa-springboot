...
import com.teamcenter.services.loose.core._2006_03.DataManagement.ExtendedAttributes;
import com.teamcenter.services.loose.core._2006_03.DataManagement.GenerateItemIdsAndInitialRevisionIdsProperties;
import com.teamcenter.services.loose.core._2006_03.DataManagement.GenerateItemIdsAndInitialRevisionIdsResponse;
import com.teamcenter.services.loose.core._2006_03.DataManagement.GenerateRevisionIdsProperties;
import com.teamcenter.services.loose.core._2006_03.DataManagement.GenerateRevisionIdsResponse;
import com.teamcenter.services.loose.core._2006_03.DataManagement.ItemIdsAndInitialRevisionIds;
import com.teamcenter.services.loose.core._2006_03.DataManagement.ItemProperties;
import com.teamcenter.services.loose.core._2006_03.DataManagement.RevisionIds;
import com.teamcenter.services.loose.core._2007_01.DataManagement.CreateOrUpdateFormsResponse;
import com.teamcenter.services.loose.core._2007_01.DataManagement.FormAttributesInfo;
import com.teamcenter.services.loose.core._2007_01.DataManagement.FormInfo;
import com.teamcenter.services.loose.core._2007_01.DataManagement.GetItemCreationRelatedInfoResponse;
import com.teamcenter.services.loose.core._2008_06.DataManagement.ReviseInfo;
import com.teamcenter.services.loose.core._2008_06.DataManagement.ReviseResponse2;
...
public class DataManagement
{
     ...
     */
    @SuppressWarnings("unchecked")
    public Map<BigInteger,RevisionIds> generateRevisionIds(ModelObject[] items) throws ServiceException
    {
        // Get the service stub
        DataManagementService dmService = DataManagementService.getService(AppXSession.getConnection());
     ...
     * @throws ServiceException         If any partial errors are returned
     */
    public void reviseItems(Map<BigInteger,RevisionIds> revisionIds, ModelObject[] itemRevs) throws ServiceException
    {
        // Get the service stub
        DataManagementService dmService = DataManagementService.getService(AppXSession.getConnection());
     ...
     * @throws ServiceException    If any partial errors are returned
     */
    public void deleteItems(ModelObject[] items) throws ServiceException
    {
        // Get the service stub
        DataManagementService dmService = DataManagementService.getService(AppXSession.getConnection());
